...
class hCI(CIWavefunction):
    ...
    ***Reference: Hierarchy Configuration Interaction: Combining Seniority Number
    ...
    """
    def __init__(
        self, nelec, nspin,alpha1, alpha2, sds=None, memory=None, hierarchy=None, refwfn=None):
    ...
    def assign_hierarchy(self, hierarchy=None):
        ...
        if __debug__:
            ...
            if hierarchy <= 0.:
                raise ValueError("`hierarchy` must be greater than zero.")
        ...
        if __debug__:
            for alpha in alphas:
                ...
                if alpha <0 or alpha > 1:
                    raise ValueError("`alpha` must be greater than or equal to zero and less than or equal to 1..") 
    ...
    def assign_sds(self, sds=None):
        ...
        ground_state = ground(self.nelec, self.nspin)
