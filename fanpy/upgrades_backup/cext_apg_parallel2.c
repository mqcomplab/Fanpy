...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fanpy.upgrades.cext_apg_parallel2",
        "sources": [
            "fanpy/upgrades/cext_apg_parallel2.pyx"
        ]
    },
    "module_name": "fanpy.upgrades.cext_apg_parallel2"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fanpy__upgrades__cext_apg_parallel2
#define __PYX_HAVE_API__fanpy__upgrades__cext_apg_parallel2
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'fanpy.upgrades.cext_apg_parallel2' */
...
static double __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser(__Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
static void __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser_deriv(__Pyx_memviewslice, __Pyx_memviewslice, long, int, double *); /*proto*/
static long __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_countbits(unsigned long); /*proto*/
static long __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_bitparity(unsigned long); /*proto*/
...
#define __Pyx_MODULE_NAME "fanpy.upgrades.cext_apg_parallel2"
extern int __pyx_module_is_main_fanpy__upgrades__cext_apg_parallel2;
int __pyx_module_is_main_fanpy__upgrades__cext_apg_parallel2 = 0;

/* Implementation of 'fanpy.upgrades.cext_apg_parallel2' */
...
static const char __pyx_k_npair[] = "npair";
...
static const char __pyx_k_deriv_local[] = "deriv_local";
static const char __pyx_k_num_orbpairs[] = "num_orbpairs";
...
static const char __pyx_k_fanpy_upgrades_cext_apg_parallel[] = "fanpy/upgrades/cext_apg_parallel2.pyx";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_fanpy_upgrades_cext_apg_parallel_2[] = "fanpy.upgrades.cext_apg_parallel2";
...
static PyObject *__pyx_n_s_deriv_local;
...
static PyObject *__pyx_n_s_num_orbpairs;
...
static PyObject *__pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2__olp_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin); /* proto */
static PyObject *__pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin); /* proto */
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":34
...
static double __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser(__Pyx_memviewslice __pyx_v_submatrix, __Pyx_memviewslice __pyx_v_orbpairs, int __pyx_v_nspin) {
  int __pyx_v_n;
  long *__pyx_v_col_inds;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  ...
  unsigned long __pyx_v_z;
  unsigned long __pyx_v_z_matrix;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":35
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef double ryser(double[:, :] submatrix, long[:] orbpairs, int nspin) nogil:
 *     cdef int n = submatrix.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":38
 * 
 *     # cdef long col_inds[npairs]
 ...
 *     for k in range(n):
 */
  __pyx_v_col_inds = ((long *)malloc(((sizeof(long)) * __pyx_v_n)));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":40
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)
 *     cdef int i, j, k
 *     for k in range(n):             # <<<<<<<<<<<<<<
 *         i = orbpairs[2 * k]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":41
 *     cdef int i, j, k
 *     for k in range(n):
 *         i = orbpairs[2 * k]             # <<<<<<<<<<<<<<
 *         j = orbpairs[2 * k + 1]
 ...
 */
    ...
    __pyx_v_i = (*((long *) ( /* dim=0 */ (__pyx_v_orbpairs.data + __pyx_t_4 * __pyx_v_orbpairs.strides[0]) )));

    /* "fanpy/upgrades/cext_apg_parallel2.pyx":42
 *     for k in range(n):
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]             # <<<<<<<<<<<<<<
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)
 * 
 */
    __pyx_t_4 = ((2 * __pyx_v_k) + 1);
    __pyx_v_j = (*((long *) ( /* dim=0 */ (__pyx_v_orbpairs.data + __pyx_t_4 * __pyx_v_orbpairs.strides[0]) )));

    /* "fanpy/upgrades/cext_apg_parallel2.pyx":43
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    (__pyx_v_col_inds[__pyx_v_k]) = (((__pyx_v_nspin * __pyx_v_i) - __Pyx_div_long((__pyx_v_i * (__pyx_v_i + 1)), 2)) + ((__pyx_v_j - __pyx_v_i) - 1));
  }

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":46
 * 
 *     cdef double rowsum, rowsumprod
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":47
 *     cdef double rowsum, rowsumprod
 *     cdef double perm = 0.0
 *     cdef unsigned long exp = 1 << n             # <<<<<<<<<<<<<<
 *     cdef unsigned long x
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":50
 *     cdef unsigned long x
 *     cdef unsigned long y, z, z_matrix
 *     for x in range(exp):             # <<<<<<<<<<<<<<
 *         rowsumprod = 1.0
 *         for y in range(n):
 */
  __pyx_t_5 = __pyx_v_exp;
  __pyx_t_6 = __pyx_t_5;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    __pyx_v_x = __pyx_t_7;

    /* "fanpy/upgrades/cext_apg_parallel2.pyx":51
 *     cdef unsigned long y, z, z_matrix
 *     for x in range(exp):
 *         rowsumprod = 1.0             # <<<<<<<<<<<<<<
 *         for y in range(n):
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":52
 *     for x in range(exp):
 *         rowsumprod = 1.0
 *         for y in range(n):             # <<<<<<<<<<<<<<
 *             rowsum = 0.0
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_2; __pyx_t_8+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":53
 *         rowsumprod = 1.0
 *         for y in range(n):
 *             rowsum = 0.0             # <<<<<<<<<<<<<<
 *             for z in range(n):
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":54
 *         for y in range(n):
 *             rowsum = 0.0
 *             for z in range(n):             # <<<<<<<<<<<<<<
 *                 z_matrix = col_inds[z]
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":55
 *             rowsum = 0.0
 *             for z in range(n):
 *                 z_matrix = col_inds[z]             # <<<<<<<<<<<<<<
 *                 if x & (1 << z) != 0:
 ...
 */
        __pyx_v_z_matrix = (__pyx_v_col_inds[__pyx_v_z]);

        /* "fanpy/upgrades/cext_apg_parallel2.pyx":56
 *             for z in range(n):
 *                 z_matrix = col_inds[z]
 *                 if x & (1 << z) != 0:             # <<<<<<<<<<<<<<
 *                     rowsum += submatrix[y, z_matrix]
 ...
 */
        ...
        if (__pyx_t_11) {
          ...
          /* "fanpy/upgrades/cext_apg_parallel2.pyx":57
 *                 z_matrix = col_inds[z]
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *             rowsumprod *= rowsum
 ...
 */
          ...
          __pyx_t_13 = __pyx_v_z_matrix;
          __pyx_v_rowsum = (__pyx_v_rowsum + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_submatrix.data + __pyx_t_12 * __pyx_v_submatrix.strides[0]) ) + __pyx_t_13 * __pyx_v_submatrix.strides[1]) ))));
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":58
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]
 *             rowsumprod *= rowsum             # <<<<<<<<<<<<<<
 *         perm += rowsumprod * bitparity(x)
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":59
 *                     rowsum += submatrix[y, z_matrix]
 *             rowsumprod *= rowsum
 *         perm += rowsumprod * bitparity(x)             # <<<<<<<<<<<<<<
 *     if n % 2 == 1:
 *         perm *= -1
 */
    __pyx_v_perm = (__pyx_v_perm + (__pyx_v_rowsumprod * __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_bitparity(__pyx_v_x)));
  }

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":60
 *             rowsumprod *= rowsum
 *         perm += rowsumprod * bitparity(x)
 *     if n % 2 == 1:             # <<<<<<<<<<<<<<
 *         perm *= -1
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":61
 *         perm += rowsumprod * bitparity(x)
 *     if n % 2 == 1:
 *         perm *= -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":63
 *         perm *= -1
 * 
 *     free(col_inds)             # <<<<<<<<<<<<<<
 *     return perm
 * 
 */
  free(__pyx_v_col_inds);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":64
 * 
 *     free(col_inds)
 *     return perm             # <<<<<<<<<<<<<<
 * 
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":69
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static void __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser_deriv(__Pyx_memviewslice __pyx_v_submatrix, __Pyx_memviewslice __pyx_v_orbpairs, long __pyx_v_sign, int __pyx_v_nspin, double *__pyx_v_deriv) {
  int __pyx_v_n;
  CYTHON_UNUSED int __pyx_v_num_orbpairs;
  long *__pyx_v_col_inds;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  ...
  unsigned int __pyx_v_z_matrix;
  double *__pyx_v_rowsum_vec;
  double *__pyx_v_rowsumprod;
  double __pyx_v_temp;
  double *__pyx_v_rowsumprod_vec;
  double *__pyx_v_perm_vec;
  int __pyx_v_p;
  int __pyx_v_q;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":76
 *     double* deriv,
 * ) nogil:
 *     cdef int n = submatrix.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":77
 * ) nogil:
 *     cdef int n = submatrix.shape[0]
 *     cdef int num_orbpairs = submatrix.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":80
 * 
 *     # cdef long col_inds[npairs]
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)             # <<<<<<<<<<<<<<
 *     cdef int i, j, k
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":82
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)
 *     cdef int i, j, k
 *     for k in range(n):             # <<<<<<<<<<<<<<
 *         i = orbpairs[2 * k]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":83
 *     cdef int i, j, k
 *     for k in range(n):
 *         i = orbpairs[2 * k]             # <<<<<<<<<<<<<<
 *         j = orbpairs[2 * k + 1]
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":84
 *     for k in range(n):
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]             # <<<<<<<<<<<<<<
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":85
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":89
 *     cdef double rowsum
 *     # cdef double perm = 0.0
 *     cdef unsigned long exp = 1 << n             # <<<<<<<<<<<<<<
 *     cdef unsigned long x
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":94
 * 
 ...
 */
  __pyx_v_rowsum_vec = ((double *)malloc(((sizeof(double)) * __pyx_v_n)));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":96
 *     cdef double *rowsum_vec = <double *> malloc(sizeof(double) * n)
 *     # cdef double rowsumprod[npairs_squared]
 *     cdef double *rowsumprod = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_rowsumprod = ((double *)malloc(((sizeof(double)) * __Pyx_pow_long(((long)__pyx_v_n), 2))));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":97
 *     # cdef double rowsumprod[npairs_squared]
 *     cdef double *rowsumprod = <double *> malloc(sizeof(double) * n ** 2)
 *     cdef double temp = 1.0             # <<<<<<<<<<<<<<
 *     # cdef double rowsumprod_vec[npairs_squared]
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":99
 *     cdef double temp = 1.0
 *     # cdef double rowsumprod_vec[npairs_squared]
 *     cdef double *rowsumprod_vec = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_rowsumprod_vec = ((double *)malloc(((sizeof(double)) * __Pyx_pow_long(((long)__pyx_v_n), 2))));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":101
 *     cdef double *rowsumprod_vec = <double *> malloc(sizeof(double) * n ** 2)
 *     # cdef double perm_vec[npairs_squared]
 *     cdef double *perm_vec = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 *     cdef int p, q
 * 
 */
  __pyx_v_perm_vec = ((double *)malloc(((sizeof(double)) * __Pyx_pow_long(((long)__pyx_v_n), 2))));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":104
 *     cdef int p, q
 * 
 *     for p in range(n):             # <<<<<<<<<<<<<<
 *         for q in range(n):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":105
 * 
 *     for p in range(n):
 *         for q in range(n):             # <<<<<<<<<<<<<<
 *             perm_vec[p * n + q] = 0.0
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":106
 *     for p in range(n):
 *         for q in range(n):
 *             perm_vec[p * n + q] = 0.0             # <<<<<<<<<<<<<<
 *     for x in range(exp):
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":107
 *         for q in range(n):
 *             perm_vec[p * n + q] = 0.0
 *     for x in range(exp):             # <<<<<<<<<<<<<<
 *         # rowsumprod = 1.0
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":109
 *     for x in range(exp):
 *         # rowsumprod = 1.0
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":110
 *         # rowsumprod = 1.0
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] = 1.0
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":111
 *         for p in range(n):
 *             for q in range(n):
 *                 rowsumprod[p * n + q] = 1.0             # <<<<<<<<<<<<<<
 *                 rowsumprod_vec[p * n + q] = 1.0
 ...
 */
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":112
 *             for q in range(n):
 *                 rowsumprod[p * n + q] = 1.0
 *                 rowsumprod_vec[p * n + q] = 1.0             # <<<<<<<<<<<<<<
 *         for y in range(n):
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":113
 *                 rowsumprod[p * n + q] = 1.0
 *                 rowsumprod_vec[p * n + q] = 1.0
 *         for y in range(n):             # <<<<<<<<<<<<<<
 *             rowsum = 0.0
 ...
 */
    ...
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_2; __pyx_t_11+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":114
 *                 rowsumprod_vec[p * n + q] = 1.0
 *         for y in range(n):
 *             rowsum = 0.0             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":115
 *         for y in range(n):
 *             rowsum = 0.0
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 rowsum_vec[q] = 0.0
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":116
 *             rowsum = 0.0
 *             for q in range(n):
 *                 rowsum_vec[q] = 0.0             # <<<<<<<<<<<<<<
 *             for z in range(n):
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":117
 *             for q in range(n):
 *                 rowsum_vec[q] = 0.0
 *             for z in range(n):             # <<<<<<<<<<<<<<
 *                 z_matrix = col_inds[z]
 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_5; __pyx_t_12+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":118
 *                 rowsum_vec[q] = 0.0
 *             for z in range(n):
 *                 z_matrix = col_inds[z]             # <<<<<<<<<<<<<<
 *                 # if x includes z
 ...
 */
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":120
 *                 z_matrix = col_inds[z]
 *                 # if x includes z
 *                 if x & (1 << z) != 0:             # <<<<<<<<<<<<<<
 *                     rowsum += submatrix[y, z_matrix]
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "fanpy/upgrades/cext_apg_parallel2.pyx":121
 *                 # if x includes z
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *                     rowsum_vec[z] = submatrix[y, z_matrix]
 ...
 */
          ...
          __pyx_t_15 = __pyx_v_z_matrix;
          __pyx_v_rowsum = (__pyx_v_rowsum + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_submatrix.data + __pyx_t_14 * __pyx_v_submatrix.strides[0]) ) + __pyx_t_15 * __pyx_v_submatrix.strides[1]) ))));

          /* "fanpy/upgrades/cext_apg_parallel2.pyx":122
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]
 *                     rowsum_vec[z] = submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *             # rowsumprod *= rowsum
 ...
 */
          ...
          (__pyx_v_rowsum_vec[__pyx_v_z]) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_submatrix.data + __pyx_t_15 * __pyx_v_submatrix.strides[0]) ) + __pyx_t_14 * __pyx_v_submatrix.strides[1]) )));
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":124
 *                     rowsum_vec[z] = submatrix[y, z_matrix]
 *             # rowsumprod *= rowsum
 *             for q in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":127
 *                 # fixe: can't handle zeros
 *                 # rowsumprod[q] *= rowsum - rowsum_vec[q]
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":131
 *         # create array such that each element (i, j) is a product of elements in column j except
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":132
 *         # for element at row i
 *         for q in range(n):
 *             temp = 1.0             # <<<<<<<<<<<<<<
 *             for p in range(n):
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":133
 *         for q in range(n):
 *             temp = 1.0
 *             for p in range(n):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] *= temp
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":134
 *             temp = 1.0
 *             for p in range(n):
 *                 rowsumprod[p * n + q] *= temp             # <<<<<<<<<<<<<<
 *                 temp *= rowsumprod_vec[p * n + q]
 *             temp = 1.0
 */
        __pyx_t_16 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
        (__pyx_v_rowsumprod[__pyx_t_16]) = ((__pyx_v_rowsumprod[__pyx_t_16]) * __pyx_v_temp);

        /* "fanpy/upgrades/cext_apg_parallel2.pyx":135
 *             for p in range(n):
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]             # <<<<<<<<<<<<<<
 *             temp = 1.0
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":136
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]
 *             temp = 1.0             # <<<<<<<<<<<<<<
 *             for p in range(n - 1, -1, -1):
 ...
 */
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":137
 *                 temp *= rowsumprod_vec[p * n + q]
 *             temp = 1.0
 *             for p in range(n - 1, -1, -1):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] *= temp
 ...
 */
      for (__pyx_t_5 = (__pyx_v_n - 1); __pyx_t_5 > -1; __pyx_t_5-=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":138
 *             temp = 1.0
 *             for p in range(n - 1, -1, -1):
 *                 rowsumprod[p * n + q] *= temp             # <<<<<<<<<<<<<<
 *                 temp *= rowsumprod_vec[p * n + q]
 *         # perm += rowsumprod * bitparity(x)
 */
        __pyx_t_6 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
        (__pyx_v_rowsumprod[__pyx_t_6]) = ((__pyx_v_rowsumprod[__pyx_t_6]) * __pyx_v_temp);

        /* "fanpy/upgrades/cext_apg_parallel2.pyx":139
 *             for p in range(n - 1, -1, -1):
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]             # <<<<<<<<<<<<<<
 *         # perm += rowsumprod * bitparity(x)
 ...
 */
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":141
 *                 temp *= rowsumprod_vec[p * n + q]
 *         # perm += rowsumprod * bitparity(x)
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":142
 *         # perm += rowsumprod * bitparity(x)
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 # if x excludes q
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":145
 *                 # if x excludes q
 *                 # if x & (1 << q) == 0 and rowsumprod_vec[p * n + q] != 0:
 *                 if x & (1 << q) == 0:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "fanpy/upgrades/cext_apg_parallel2.pyx":146
 *                 # if x & (1 << q) == 0 and rowsumprod_vec[p * n + q] != 0:
 *                 if x & (1 << q) == 0:
 *                     perm_vec[p * n + q] += rowsumprod[p * n + q] * (-bitparity(x))             # <<<<<<<<<<<<<<
 *     if n % 2 == 1:
 ...
 */
          __pyx_t_16 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
          (__pyx_v_perm_vec[__pyx_t_16]) = ((__pyx_v_perm_vec[__pyx_t_16]) + ((__pyx_v_rowsumprod[((__pyx_v_p * __pyx_v_n) + __pyx_v_q)]) * (-__pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_bitparity(__pyx_v_x))));
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":147
 *                 if x & (1 << q) == 0:
 *                     perm_vec[p * n + q] += rowsumprod[p * n + q] * (-bitparity(x))
 *     if n % 2 == 1:             # <<<<<<<<<<<<<<
 *         # perm *= -1
 ...
 */
  ...
  if (__pyx_t_13) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":149
 *     if n % 2 == 1:
 *         # perm *= -1
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":150
 *         # perm *= -1
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 perm_vec[p * n + q] *= -1
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "fanpy/upgrades/cext_apg_parallel2.pyx":151
 *         for p in range(n):
 *             for q in range(n):
 *                 perm_vec[p * n + q] *= -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_16 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
        (__pyx_v_perm_vec[__pyx_t_16]) = ((__pyx_v_perm_vec[__pyx_t_16]) * -1.0);
      }
    }
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":153
 *                 perm_vec[p * n + q] *= -1
 * 
 *     for p in range(n):             # <<<<<<<<<<<<<<
 *         for q in range(n):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fanpy/upgrades/cext_apg_parallel2.pyx":154
 * 
 *     for p in range(n):
 *         for q in range(n):             # <<<<<<<<<<<<<<
 *             # deriv[p * num_orbpairs + col_inds[q]] += sign * perm_vec[p * n + q]
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "fanpy/upgrades/cext_apg_parallel2.pyx":156
 *         for q in range(n):
 *             # deriv[p * num_orbpairs + col_inds[q]] += sign * perm_vec[p * n + q]
 *             deriv[p * n + q] += sign * perm_vec[p * n + q]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_16 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
      (__pyx_v_deriv[__pyx_t_16]) = ((__pyx_v_deriv[__pyx_t_16]) + (__pyx_v_sign * (__pyx_v_perm_vec[((__pyx_v_p * __pyx_v_n) + __pyx_v_q)])));
    }
  }

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":158
 *             deriv[p * n + q] += sign * perm_vec[p * n + q]
 * 
 *     free(col_inds)             # <<<<<<<<<<<<<<
 *     free(rowsum_vec)
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":159
 * 
 *     free(col_inds)
 *     free(rowsum_vec)             # <<<<<<<<<<<<<<
 *     free(rowsumprod)
 *     free(rowsumprod_vec)
 */
  free(__pyx_v_rowsum_vec);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":160
 *     free(col_inds)
 *     free(rowsum_vec)
 *     free(rowsumprod)             # <<<<<<<<<<<<<<
 *     free(rowsumprod_vec)
 *     free(perm_vec)
 */
  free(__pyx_v_rowsumprod);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":161
 *     free(rowsum_vec)
 *     free(rowsumprod)
 *     free(rowsumprod_vec)             # <<<<<<<<<<<<<<
 *     free(perm_vec)
 * 
 */
  free(__pyx_v_rowsumprod_vec);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":162
 *     free(rowsumprod)
 *     free(rowsumprod_vec)
 *     free(perm_vec)             # <<<<<<<<<<<<<<
 * 
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":166
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static long __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_countbits(unsigned long __pyx_v_n) {
  unsigned long __pyx_v_q;
  long __pyx_r;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":167
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef long countbits(unsigned long n) nogil:
 *     cdef unsigned long q = n             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":168
 * cdef long countbits(unsigned long n) nogil:
 *     cdef unsigned long q = n
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 ...
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x5555555555555555)) + ((__pyx_v_q & ((unsigned long)0xAAAAAAAAAAAAAAAA)) >> 1));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":169
 *     cdef unsigned long q = n
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 ...
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x3333333333333333)) + ((__pyx_v_q & ((unsigned long)0xCCCCCCCCCCCCCCCC)) >> 2));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":170
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)
 ...
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x0F0F0F0F0F0F0F0F)) + ((__pyx_v_q & ((unsigned long)0xF0F0F0F0F0F0F0F0)) >> 4));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":171
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)
 ...
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x00FF00FF00FF00FF)) + ((__pyx_v_q & ((unsigned long)0xFF00FF00FF00FF00)) >> 8));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":172
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)             # <<<<<<<<<<<<<<
 *     # This last & isn't strictly necessary.
 ...
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x0000FFFF0000FFFF)) + ((__pyx_v_q & ((unsigned long)0xFFFF0000FFFF0000)) >> 16));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":174
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)
 *     # This last & isn't strictly necessary.
 *     q = (q & <unsigned long>0x00000000FFFFFFFF) + ((q & <unsigned long>0xFFFFFFFF00000000) >> 32)             # <<<<<<<<<<<<<<
 *     return q;
 * 
 */
  __pyx_v_q = ((__pyx_v_q & ((unsigned long)0x00000000FFFFFFFF)) + ((__pyx_v_q & ((unsigned long)0xFFFFFFFF00000000)) >> 32));

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":175
 *     # This last & isn't strictly necessary.
 *     q = (q & <unsigned long>0x00000000FFFFFFFF) + ((q & <unsigned long>0xFFFFFFFF00000000) >> 32)
 *     return q;             # <<<<<<<<<<<<<<
 * 
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":179
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static long __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_bitparity(unsigned long __pyx_v_n) {
  long __pyx_r;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":180
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef long bitparity (unsigned long n) nogil:
 *     return 1 - (countbits(n) & 1)*2             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)  # Deactivate bounds checking
 */
  __pyx_r = (1 - ((__pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_countbits(__pyx_v_n) & 1) * 2));
  goto __pyx_L0;
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":184
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
/* Python wrapper */
static PyObject *__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_1_olp_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5fanpy_8upgrades_18cext_apg_parallel2_1_olp_internal = {"_olp_internal", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_1_olp_internal, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_1_olp_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_olp_internal (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_params)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_olp_internal", 1, 3, 3, 1); __PYX_ERR(0, 184, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nspin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_olp_internal", 1, 3, 3, 2); __PYX_ERR(0, 184, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_olp_internal") < 0)) __PYX_ERR(0, 184, __pyx_L3_error)
      }
    ...
    __pyx_v_params = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_params.memview)) __PYX_ERR(0, 184, __pyx_L3_error)
    __pyx_v_nspin = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_nspin == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 184, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_olp_internal", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 184, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fanpy.upgrades.cext_apg_parallel2._olp_internal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_orbpairs_sign), (&PyList_Type), 1, "orbpairs_sign", 1))) __PYX_ERR(0, 184, __pyx_L1_error)
  __pyx_r = __pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2__olp_internal(__pyx_self, __pyx_v_orbpairs_sign, __pyx_v_params, __pyx_v_nspin);
...
static PyObject *__pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2__olp_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin) {
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":185
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * def _olp_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)             # <<<<<<<<<<<<<<
 *     cdef int nelec = 2 * params.shape[0]
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 185, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_orbpairs_sign_view = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":186
 * def _olp_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int nelec = 2 * params.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":188
 *     cdef int nelec = 2 * params.shape[0]
 * 
 *     cdef double output = 0.0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":190
 *     cdef double output = 0.0
 *     cdef Py_ssize_t i
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_orbpairs_sign_view.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("orbpairs_sign_view"); __PYX_ERR(0, 190, __pyx_L4_error) }
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_output) private(__pyx_t_11, __pyx_t_8, __pyx_t_9) firstprivate(__pyx_t_10) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":193
 *     # for i in range(orbpairs_sign_view.shape[0]):
 *         output += (
 ...
 */
                            ...
                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":195
 *             orbpairs_sign_view[i, nelec] *
 *             # ryser(params, col_inds_apg(orbpairs_sign_view[i, :nelec], nspin))
 *             ryser(params, orbpairs_sign_view[i, :nelec], nspin)             # <<<<<<<<<<<<<<
 *         )
...
__pyx_t_11 = -1;
    ...
    1) < 0))
{
    __PYX_ERR(0, 195, __pyx_L8_error)
}

__pyx_v_output = (__pyx_v_output + ((*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_8 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_9 * __pyx_v_orbpairs_sign_view.strides[1]) ))) * __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser(__pyx_v_params, __pyx_t_10, __pyx_v_nspin)));

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":192
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *     # for i in range(orbpairs_sign_view.shape[0]):
 *         output += (             # <<<<<<<<<<<<<<
 *             orbpairs_sign_view[i, nelec] *
 ...
 */
                            ...
                            #endif /* _OPENMP */
                            {
                                ...
                                __pyx_parallel_temp1 = __pyx_v_output;
                            }
                            __pyx_L11:;
                            #ifdef _OPENMP
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              ...
              __pyx_v_output = __pyx_parallel_temp1;
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":197
 *             ryser(params, orbpairs_sign_view[i, :nelec], nspin)
 *         )
 *     return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_output); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 197, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "fanpy/upgrades/cext_apg_parallel2.pyx":202
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
/* Python wrapper */
static PyObject *__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5fanpy_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal = {"_olp_deriv_internal", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5fanpy_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_orbpairs_sign = 0;
  __Pyx_memviewslice __pyx_v_params = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_nspin;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("_olp_deriv_internal (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_params)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_olp_deriv_internal", 1, 3, 3, 1); __PYX_ERR(0, 202, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nspin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_olp_deriv_internal", 1, 3, 3, 2); __PYX_ERR(0, 202, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_olp_deriv_internal") < 0)) __PYX_ERR(0, 202, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_orbpairs_sign = ((PyObject*)values[0]);
    __pyx_v_params = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_params.memview)) __PYX_ERR(0, 202, __pyx_L3_error)
    __pyx_v_nspin = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_nspin == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 202, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_olp_deriv_internal", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 202, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fanpy.upgrades.cext_apg_parallel2._olp_deriv_internal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_orbpairs_sign), (&PyList_Type), 1, "orbpairs_sign", 1))) __PYX_ERR(0, 202, __pyx_L1_error)
  __pyx_r = __pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(__pyx_self, __pyx_v_orbpairs_sign, __pyx_v_params, __pyx_v_nspin);
...
static PyObject *__pyx_pf_5fanpy_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin) {
  __Pyx_memviewslice __pyx_v_orbpairs_sign_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_npair;
  int __pyx_v_nelec;
  CYTHON_UNUSED int __pyx_v_nparams;
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":203
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * def _olp_deriv_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)             # <<<<<<<<<<<<<<
 *     cdef int npair = params.shape[0]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_orbpairs_sign_view = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":204
 * def _olp_deriv_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int npair = params.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int nelec = 2 * params.shape[0]
 ...
 */
  __pyx_v_npair = (__pyx_v_params.shape[0]);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":205
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int npair = params.shape[0]
 *     cdef int nelec = 2 * params.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int nparams = params.size
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":206
 *     cdef int npair = params.shape[0]
 *     cdef int nelec = 2 * params.shape[0]
 *     cdef int nparams = params.size             # <<<<<<<<<<<<<<
 *     cdef int num_orbpairs = params.shape[1]
 * 
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_params, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_nparams = __pyx_t_5;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":207
 *     cdef int nelec = 2 * params.shape[0]
 *     cdef int nparams = params.size
 *     cdef int num_orbpairs = params.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_num_orbpairs = (__pyx_v_params.shape[1]);

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":209
 *     cdef int num_orbpairs = params.shape[1]
 * 
 *     deriv = np.zeros(params.size)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_params, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 209, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 209, __pyx_L1_error)
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":210
 * 
 *     deriv = np.zeros(params.size)
 *     cdef double[:] deriv_view = deriv             # <<<<<<<<<<<<<<
 *     # deriv = <double*>malloc(sizeof(double)*nparams)
 * 
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_deriv, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 210, __pyx_L1_error)
  __pyx_v_deriv_view = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "fanpy/upgrades/cext_apg_parallel2.pyx":216
 *     cdef Py_ssize_t p, q
 *     cdef int col_ind
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_orbpairs_sign_view.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("orbpairs_sign_view"); __PYX_ERR(0, 216, __pyx_L4_error) }
        __pyx_t_8 = (__pyx_v_orbpairs_sign_view.shape[0]);
        if ((1 == 0)) abort();
        {
            int __pyx_parallel_temp0 = ((int)0xbad0bad0);
            double * __pyx_parallel_temp1 = ((double *)1);
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_5) firstprivate(__pyx_t_14) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_col_ind) lastprivate(__pyx_v_deriv_local) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_k) lastprivate(__pyx_v_p) lastprivate(__pyx_v_q) schedule(static)
                    #endif /* _OPENMP */
                    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            __pyx_v_col_ind = ((int)0xbad0bad0);
                            __pyx_v_deriv_local = ((double *)1);
                            __pyx_v_j = ((int)0xbad0bad0);
                            __pyx_v_k = ((int)0xbad0bad0);
                            __pyx_v_p = ((Py_ssize_t)0xbad0bad0);
                            __pyx_v_q = ((Py_ssize_t)0xbad0bad0);

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":217
 *     cdef int col_ind
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)             # <<<<<<<<<<<<<<
 *         for p in range(npair ** 2):
 *             deriv_local[p] = 0
 */
                            __pyx_v_deriv_local = ((double *)malloc(((sizeof(double)) * __Pyx_pow_long(((long)__pyx_v_npair), 2))));

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":218
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)
 *         for p in range(npair ** 2):             # <<<<<<<<<<<<<<
 *             deriv_local[p] = 0
 *         ryser_deriv(
 */
                            __pyx_t_11 = __Pyx_pow_long(((long)__pyx_v_npair), 2);
                            __pyx_t_12 = __pyx_t_11;
                            for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
                              __pyx_v_p = __pyx_t_13;

                              /* "fanpy/upgrades/cext_apg_parallel2.pyx":219
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)
 *         for p in range(npair ** 2):
 *             deriv_local[p] = 0             # <<<<<<<<<<<<<<
 *         ryser_deriv(
 *             params,
 */
                              (__pyx_v_deriv_local[__pyx_v_p]) = 0.0;
                            }

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":222
 *         ryser_deriv(
 *             params,
 *             orbpairs_sign_view[i, :nelec],             # <<<<<<<<<<<<<<
 *             orbpairs_sign_view[i, nelec],
 *             nspin,
 */
                            __pyx_t_14.data = __pyx_v_orbpairs_sign_view.data;
                            __pyx_t_14.memview = __pyx_v_orbpairs_sign_view.memview;
...
__pyx_t_15 = __pyx_v_i;
                            ...
                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":223
 *             params,
 *             orbpairs_sign_view[i, :nelec],
 *             orbpairs_sign_view[i, nelec],             # <<<<<<<<<<<<<<
 *             nspin,
 *             deriv_local
 */
                            __pyx_t_16 = __pyx_v_nelec;

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":220
 *         for p in range(npair ** 2):
 *             deriv_local[p] = 0
 *         ryser_deriv(             # <<<<<<<<<<<<<<
 *             params,
 *             orbpairs_sign_view[i, :nelec],
 */
                            __pyx_f_5fanpy_8upgrades_18cext_apg_parallel2_ryser_deriv(__pyx_v_params, __pyx_t_14, (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_15 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_16 * __pyx_v_orbpairs_sign_view.strides[1]) ))), __pyx_v_nspin, __pyx_v_deriv_local);
                            __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
                            __pyx_t_14.memview = NULL;
                            __pyx_t_14.data = NULL;

                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":227
 *             deriv_local
 *         )
 *         with gil:             # <<<<<<<<<<<<<<
 ...
 */
                            {
                                ...
                                /*try:*/ {
                                  ...
                                  /* "fanpy/upgrades/cext_apg_parallel2.pyx":228
 *         )
 *         with gil:
 *             for p in range(npair):             # <<<<<<<<<<<<<<
 *                 for q in range(npair):
 ...
 */
                                    __pyx_t_18 = __pyx_v_npair;
                                    __pyx_t_19 = __pyx_t_18;
                                    for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
                                      __pyx_v_q = __pyx_t_20;

                                      /* "fanpy/upgrades/cext_apg_parallel2.pyx":230
 *             for p in range(npair):
 *                 for q in range(npair):
 *                     j = orbpairs_sign_view[i, 2 * q]             # <<<<<<<<<<<<<<
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 ...
 */
                                      ...
                                      __pyx_t_15 = (2 * __pyx_v_q);
                                      __pyx_v_j = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_16 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_15 * __pyx_v_orbpairs_sign_view.strides[1]) )));

                                      /* "fanpy/upgrades/cext_apg_parallel2.pyx":231
 *                 for q in range(npair):
 *                     j = orbpairs_sign_view[i, 2 * q]
 *                     k = orbpairs_sign_view[i, 2 * q + 1]             # <<<<<<<<<<<<<<
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 ...
 */
                                      __pyx_t_15 = __pyx_v_i;
                                      __pyx_t_16 = ((2 * __pyx_v_q) + 1);
                                      __pyx_v_k = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_15 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_16 * __pyx_v_orbpairs_sign_view.strides[1]) )));

                                      /* "fanpy/upgrades/cext_apg_parallel2.pyx":232
 *                     j = orbpairs_sign_view[i, 2 * q]
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)             # <<<<<<<<<<<<<<
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 *         free(deriv_local)
 */
                                      __pyx_v_col_ind = (((__pyx_v_nspin * __pyx_v_j) - __Pyx_div_long((__pyx_v_j * (__pyx_v_j + 1)), 2)) + ((__pyx_v_k - __pyx_v_j) - 1));

                                      /* "fanpy/upgrades/cext_apg_parallel2.pyx":233
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]             # <<<<<<<<<<<<<<
 *         free(deriv_local)
 *     return deriv
 */
                                      __pyx_t_16 = ((__pyx_v_p * __pyx_v_num_orbpairs) + __pyx_v_col_ind);
                                      *((double *) ( /* dim=0 */ (__pyx_v_deriv_view.data + __pyx_t_16 * __pyx_v_deriv_view.strides[0]) )) += (__pyx_v_deriv_local[((__pyx_v_p * __pyx_v_npair) + __pyx_v_q)]);
                                    }
                                  }
                                }
 ...
 */
                            ...
                            /* "fanpy/upgrades/cext_apg_parallel2.pyx":234
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 *         free(deriv_local)             # <<<<<<<<<<<<<<
 *     return deriv
 */
                            free(__pyx_v_deriv_local);
                            goto __pyx_L22;
                            __pyx_L8_error:;
                            {
                                #ifdef WITH_THREAD
                            ...
                            #endif /* _OPENMP */
                            {
                                __pyx_parallel_temp0 = __pyx_v_col_ind;
                                __pyx_parallel_temp1 = __pyx_v_deriv_local;
                                __pyx_parallel_temp2 = __pyx_v_i;
                                __pyx_parallel_temp3 = __pyx_v_j;
                                __pyx_parallel_temp4 = __pyx_v_k;
                                __pyx_parallel_temp5 = __pyx_v_p;
                                __pyx_parallel_temp6 = __pyx_v_q;
                            }
                            __pyx_L22:;
                            #ifdef _OPENMP
                            #pragma omp flush(__pyx_parallel_why)
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              __pyx_v_col_ind = __pyx_parallel_temp0;
              __pyx_v_deriv_local = __pyx_parallel_temp1;
              __pyx_v_i = __pyx_parallel_temp2;
              __pyx_v_j = __pyx_parallel_temp3;
              __pyx_v_k = __pyx_parallel_temp4;
              __pyx_v_p = __pyx_parallel_temp5;
              __pyx_v_q = __pyx_parallel_temp6;
              switch (__pyx_parallel_why) {
                    case 4:
                {
                    #ifdef WITH_THREAD
 ...
 */
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":235
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 *         free(deriv_local)
 *     return deriv             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fanpy.upgrades.cext_apg_parallel2.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fanpy.upgrades.cext_apg_parallel2.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fanpy.upgrades.cext_apg_parallel2.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fanpy.upgrades.cext_apg_parallel2._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cext_apg_parallel2(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cext_apg_parallel2},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_deriv_local, __pyx_k_deriv_local, sizeof(__pyx_k_deriv_local), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_num_orbpairs, __pyx_k_num_orbpairs, sizeof(__pyx_k_num_orbpairs), 0, 0, 1, 1},
 ...
 *     cdef int nelec = 2 * params.shape[0]
 */
  __pyx_tuple__21 = PyTuple_Pack(7, __pyx_n_s_orbpairs_sign, __pyx_n_s_params, __pyx_n_s_nspin, __pyx_n_s_orbpairs_sign_view, __pyx_n_s_nelec, __pyx_n_s_output, __pyx_n_s_i); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(3, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fanpy_upgrades_cext_apg_parallel, __pyx_n_s_olp_internal, 184, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 184, __pyx_L1_error)
 ...
 *     cdef int npair = params.shape[0]
 */
  __pyx_tuple__23 = PyTuple_Pack(17, __pyx_n_s_orbpairs_sign, __pyx_n_s_params, __pyx_n_s_nspin, __pyx_n_s_orbpairs_sign_view, __pyx_n_s_npair, __pyx_n_s_nelec, __pyx_n_s_nparams, __pyx_n_s_num_orbpairs, __pyx_n_s_deriv, __pyx_n_s_deriv_view, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_p, __pyx_n_s_q, __pyx_n_s_col_ind, __pyx_n_s_deriv_local); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 202, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(3, 0, 17, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fanpy_upgrades_cext_apg_parallel, __pyx_n_s_olp_deriv_internal, 202, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 202, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcext_apg_parallel2(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcext_apg_parallel2(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cext_apg_parallel2(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cext_apg_parallel2(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cext_apg_parallel2(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cext_apg_parallel2' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cext_apg_parallel2(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cext_apg_parallel2", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fanpy__upgrades__cext_apg_parallel2) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fanpy.upgrades.cext_apg_parallel2")) {
      if (unlikely(PyDict_SetItemString(modules, "fanpy.upgrades.cext_apg_parallel2", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fanpy/upgrades/cext_apg_parallel2.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef int nelec = 2 * params.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5fanpy_8upgrades_18cext_apg_parallel2_1_olp_internal, NULL, __pyx_n_s_fanpy_upgrades_cext_apg_parallel_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_olp_internal, __pyx_t_1) < 0) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef int npair = params.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5fanpy_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal, NULL, __pyx_n_s_fanpy_upgrades_cext_apg_parallel_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 202, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_olp_deriv_internal, __pyx_t_1) < 0) __PYX_ERR(0, 202, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fanpy.upgrades.cext_apg_parallel2", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fanpy.upgrades.cext_apg_parallel2");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
