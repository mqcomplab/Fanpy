...
sphinx_gallery_conf = {
    ...
    # 'default_thumb_file': './_static/fanpy_white_bg_logo.png',
...
project = u"fanpy"
copyright = u"2020, Ayers' Group @ McMaster University"
...
# of the sidebar.
# html_logo = '_static/fanpy_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = "_static/fanpy_favicon.ico"
...
man_pages = [(master_doc, "fanpy", u"Project Documentation", [author], 1)]
...
# -- Custom fanpy-specific settings -------------------------------------------
